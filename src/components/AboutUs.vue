    ...
    <div id="about-us" class="flex lg:flex-row w-full justify-center items-center my-48 flex-col">
        <div class="w-[85%] flex flex-col lg:flex-row justify-center items-center lg:space-x-24">
            ...
            <div id="about-us_content" class="relative flex flex-col 2xl:space-y-14 space-y-8 xl:w-1/2 lg:w-[50%] w-full">
                ...
                <h1
                    class="text-center md:text-start text-black sm:text-[3rem] font-extrabold tracking-tight lg:text-[2rem] text-[2rem]">
                    Great
                    Digital Product Agency since 2016</h1>
                <P class="text-base text-center md:text-start text-neutral-600 lg:text-[1rem]">Our Business Plan is a
                    written
                    document
                    describing a company's core business activites, Objectives, and how it plans to achieve its goals. Our
                    goal is
